...
```{mermaid}
erDiagram
  GEOGRAPHIES ||--o{ WORLD_DEVELOPMENT_INDICATORS : has
  GEOGRAPHIES {
...
| longitude | Longitude of the geography | 28.2937 |
| latitude | Latitude of the geography | -15.3982 |
...
| year         | Month of the data point (if monthly data is requested and available).    | 2020         1  |
