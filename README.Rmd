...
The package is designed to work seamlessly with International Debt Statistics (IDS) provided through the [`wbids`](https://github.com/Teal-Insights/r-wbids) package and shares its syntax with the Python library ['py-wbwdi'](https://github.com/tidy-intelligence/py-wbwdi).
